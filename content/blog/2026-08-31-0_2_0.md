...
- Zed: offician `Rust Glancer` extension [PR is open](https://github.com/zed-industries/extensions/pull/7438), but meanwhile you can install it [from the repository](https://github.com/rust-glancer/rust-glancer/tree/main/editors/zed).
